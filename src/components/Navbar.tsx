    ...
    <>
      {visible && (
        <div className="navbarPromotion">
          <span
            className={`navbarPromotionContent ${
              animateContent ? "fadeIn" : ""
            }`}
          >
            {contents[contentIndex]}
          </span>
          <button className="navbarPromotionButton" onClick={handleClose}>
            X
          </button>
        </div>
      )}
          ...
          <div className="navbarMenuItem">
            <Link className="linkTag" to="/men">
              ...
              >
                Men
                {!hiddenMen && (
                  <div className="navbarHoverMen">{MenDropdownItems}</div>
                )}
              </div>
            </Link>
            <Link className="linkTag" to="/women">
              ...
              >
                Women
                {!hiddenWomen && (
                  <div className="navbarHoverWomen">{WomenDropdownItems}</div>
                )}
              </div>
            </Link>
            <Link className="linkTag" to="/accessories">
              <div className="navbarMenuItemAccessories">
                <p className="navbarMenuItemAccessoriesTitle">Accessories</p>
              </div>
            </Link>
          </div>
      ...
      {cartTotalQuantity !== 0 ? (
        <div
          className={`sidebarCart ${
            !sidebarCartActive ? "inactive" : sidebarCartActive ? "active" : ""
          }`}
          style={sidebarCartStyle}
        >
